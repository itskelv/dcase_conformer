...
import os.path
import torch
from parameters_multiaccdoa_model_conformer import params
...
def train_epoch(seld_model, dev_train_iterator, optimizer, seld_loss, summary_writer):
...
def main():
    ...
    for epoch in range(start_epoch, params['nb_epochs']):
        # ------------- Training -------------- #
        avg_train_loss = train_epoch(seld_model, dev_train_iterator, optimizer, seld_loss, summary_writer)
        # -------------  Validation -------------- #
        ...
        summary_writer.add_scalar('Metric/Dist_Error', val_dist_error, epoch)
        summary_writer.add_scalar('Metric/Rel_Dist_Error', val_rel_dist_error, epoch)
